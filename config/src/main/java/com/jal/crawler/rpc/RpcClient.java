...
public class RpcClient {
    ...
    private AbstractComponentClient downloadClient(String host, int port) {
        ...
        downloadClient.setChannel(getChannel(host, port));
        downloadClient.setAddress(address);
    ...
    private AbstractComponentClient resolveClient(String host, int port) {
        ...
        resolveClient.setChannel(getChannel(host, port));
        resolveClient.setAddress(address);
    ...
    private void resolveAdd(ResolveClient resolveClient) {
        resolves.put(resolveClient.getAddress(), resolveClient);
        clients.put(resolveClient.getAddress(), resolveClient);
    }

    private void downAdd(DownloadClient downloadClient) {
        downs.put(downloadClient.getAddress(), downloadClient);
        clients.put(downloadClient.getAddress(), downloadClient);
    }
    ...
    private void remove(AbstractComponentClient client) {
        ...
        downs.remove(client.getAddress());
        resolves.remove(client.getAddress());
    }
